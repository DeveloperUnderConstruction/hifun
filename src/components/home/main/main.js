          ...
          <div className="col-xs-12 col-lg-6 col-md-12 flex">
            <div className=" block-texts p-5 shadow">
              ...
              <p style={{ fontSize: "15px" }}>
                Hi-Fun is for those who love to talk, but just behind the screen :) <br></br>

                Hi-Fun Is A Chat App Which Provides Free Messaging Services. you'll
        ...
        <div className="row " id="block2">
          <div className="col-xs-12 col-lg-6 col-md-12 flex nohidden">
            <div className=" block-texts p-5 shadow">
              ...
              <p style={{ fontSize: "15px" }}>
                Easy To Understand. New Chats Are Easy To Make, you'll
          ...
          <div className="col-xs-12 col-lg-6 col-md-12 flex hidden">
            <div className=" block-texts p-5 shadow">
              ...
              <p style={{ fontSize: "15px" }}>
                Easy To Understand. New Chats Are Easy To Make, you'll
                get faster Response From This Site, So Let's Start
              </p>
              <br></br>
